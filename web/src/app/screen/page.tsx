...
const FALLBACK: ScreenOverview = {
  ...
  hostRank: [
    { name: "g32-bet-settle-01", score: 38, issues: "内存马" },
    { name: "game-center-11", score: 45, issues: "勒索特征" },
    { name: "wallet-client-07", score: 52, issues: "提权" },
    { name: "openapi-gw-03", score: 58, issues: "端口扫描" },
    { name: "user-client-04", score: 61, issues: "横向移动" },
    { name: "merchant-client-05", score: 66, issues: "凭据访问" },
  ],
  attck: [
